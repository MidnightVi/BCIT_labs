...
namespace Lab3
{
    class Program
    {
        static void Main_menu()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("1.Работать с коллекцей ArrayList");
            Console.WriteLine("2.Работать с коллекцией List");
            Console.WriteLine("3.Работать с Разреженной матрицей");
            Console.WriteLine("4.Работать с Simple Stack");
                    ...
                    case 1:
                        {
                            ...
                            Console.WriteLine("Как вы ходитет отсортировать эту коллекцию?");
